...
|---|---|---|
| `ts/` | @voxgig-sdk/attack-on-titan-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/attack-on-titan-sdk \
      --repository voxgig-sdk/attack-on-titan-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/attack-on-titan-sdk` shows it, and
`npm trust revoke @voxgig-sdk/attack-on-titan-sdk --id=<id>` removes it.
