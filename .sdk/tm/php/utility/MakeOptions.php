...
// AttackOnTitan SDK utility: make_options

class AttackOnTitanMakeOptions
{
    ...
    public static function call(AttackOnTitanContext $ctx): array
    {
        ...
        //
        // `AttackOnTitanSchema::optspec()` is built from the model:
        ...
        $optspec = AttackOnTitanSchema::optspec();
