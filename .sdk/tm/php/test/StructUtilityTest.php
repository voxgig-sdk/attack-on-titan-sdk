...
// AttackOnTitan SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AttackOnTitanOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AttackOnTitanOmni::structfix($now, Struct::undef()))
                        !== json_encode(AttackOnTitanOmni::structfix($val, Struct::undef()))) {
