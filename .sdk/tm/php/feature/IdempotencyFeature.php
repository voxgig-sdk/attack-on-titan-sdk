...
// AttackOnTitan SDK idempotency feature
...
class AttackOnTitanIdempotencyFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _mutating(AttackOnTitanContext $ctx): bool
    {
