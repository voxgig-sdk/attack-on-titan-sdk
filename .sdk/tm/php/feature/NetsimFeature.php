...
// AttackOnTitan SDK netsim feature
...
class AttackOnTitanNetsimFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _simulate(AttackOnTitanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AttackOnTitanContext $ctx, array $applied): void
    {
        $client = $this->client;
