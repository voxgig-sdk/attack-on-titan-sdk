...
// AttackOnTitan SDK timeout feature
...
class AttackOnTitanTimeoutFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _with_timeout(AttackOnTitanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AttackOnTitanContext $_ctx, float $ms): void
    {
        $client = $this->client;
