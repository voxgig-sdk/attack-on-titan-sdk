...
// AttackOnTitan SDK rbac feature
...
class AttackOnTitanRbacFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _required(AttackOnTitanContext $ctx): ?string
    {
    ...
    private function _reject(AttackOnTitanContext $ctx, string $required): void
    {
    ...
    private function _track(AttackOnTitanContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
