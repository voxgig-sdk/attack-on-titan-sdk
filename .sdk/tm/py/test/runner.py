...
class AttackOnTitanTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AttackOnTitanTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AttackOnTitanTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AttackOnTitanTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
