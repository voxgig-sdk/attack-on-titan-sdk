...
class AttackOnTitanTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AttackOnTitanTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AttackOnTitanTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AttackOnTitanTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
