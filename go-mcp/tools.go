...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | location | organization | titan"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AttackOnTitanSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "attack-on-titan_list",
		Description: "List records from AttackOnTitan. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "attack-on-titan_load",
		Description: "Load a single record from AttackOnTitan. " +
...
func runOp(client *sdk.AttackOnTitanSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
