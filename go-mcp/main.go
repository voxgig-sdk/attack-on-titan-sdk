// Command AttackOnTitan-mcp is an MCP server exposing the AttackOnTitan
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AttackOnTitan_list  — list records of an entity
//	AttackOnTitan_load  — load a single record of an entity
//
