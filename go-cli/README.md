...
AQL-driven CLI and REPL for the AttackOnTitan SDK. Positional arguments are
...
```sh
go build -o attack-on-titan-cli ./...
```
...
./attack-on-titan-cli load 1 character
./attack-on-titan-cli load '{id:1}' character
