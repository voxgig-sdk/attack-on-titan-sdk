# AttackOnTitan Ruby SDK



The Ruby SDK for the AttackOnTitan API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `AttackOnTitanError` (a `StandardError` subclass), so wrap
...
```
rb/
├── AttackOnTitan_sdk.rb       -- Main SDK module
