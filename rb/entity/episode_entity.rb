# AttackOnTitan SDK Episode entity
...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises AttackOnTitanError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises AttackOnTitanError on failure
