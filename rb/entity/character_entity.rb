# AttackOnTitan SDK Character entity
...
class CharacterEntity
  ...
  # @return [Character, Hash] the loaded Character; raises AttackOnTitanError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Character>, Array] the matching Character items; raises AttackOnTitanError on failure
