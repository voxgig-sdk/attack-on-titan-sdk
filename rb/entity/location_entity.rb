# AttackOnTitan SDK Location entity
...
class LocationEntity
  ...
  # @return [Location, Hash] the loaded Location; raises AttackOnTitanError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises AttackOnTitanError on failure
