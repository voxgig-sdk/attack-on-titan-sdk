# AttackOnTitan SDK Organization entity
...
class OrganizationEntity
  ...
  # @return [Organization, Hash] the loaded Organization; raises AttackOnTitanError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Organization>, Array] the matching Organization items; raises AttackOnTitanError on failure
