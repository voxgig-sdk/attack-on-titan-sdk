...
class EpisodeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ATTACK_ON_TITAN_TEST_EPISODE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def episode_basic_setup(extra)
  ...
  entid_env_raw = ENV["ATTACK_ON_TITAN_TEST_EPISODE_ENTID"]
