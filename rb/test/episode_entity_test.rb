...
class EpisodeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ATTACKONTITAN_TEST_EPISODE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def episode_basic_setup(extra)
  ...
  entid_env_raw = ENV["ATTACKONTITAN_TEST_EPISODE_ENTID"]
