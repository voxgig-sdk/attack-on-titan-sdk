...
#      offline in seeded test mode (AttackOnTitanSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AttackOnTitan_sdk.rb")
  SDK_CLASS = "AttackOnTitanSDK"
