...
// AttackOnTitan SDK utility type

class AttackOnTitanUtility
{
    ...
    public static function copy(AttackOnTitanUtility $src): AttackOnTitanUtility
    {
        $u = new AttackOnTitanUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
