...
// AttackOnTitan SDK streaming feature
...
class AttackOnTitanStreamingFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _iterate(AttackOnTitanResult $result): \Generator
    {
    ...
    private function _streamable(AttackOnTitanContext $ctx): bool
    {
