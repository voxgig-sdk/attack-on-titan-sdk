...
// AttackOnTitan SDK cache feature
...
class AttackOnTitanCacheFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _through(AttackOnTitanContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
