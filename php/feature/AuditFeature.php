...
// AttackOnTitan SDK audit feature
...
class AttackOnTitanAuditFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _emit(AttackOnTitanContext $ctx, string $outcome): void
    {
