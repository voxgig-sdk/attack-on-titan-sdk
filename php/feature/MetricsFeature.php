...
// AttackOnTitan SDK metrics feature
...
class AttackOnTitanMetricsFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _record(AttackOnTitanContext $ctx, bool $ok): void
    {
