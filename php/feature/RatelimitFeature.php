...
// AttackOnTitan SDK ratelimit feature
...
class AttackOnTitanRatelimitFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _acquire(AttackOnTitanContext $ctx): void
    {
    ...
    private function _track(AttackOnTitanContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
