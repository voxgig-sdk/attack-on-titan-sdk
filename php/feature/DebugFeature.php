...
// AttackOnTitan SDK debug feature
...
class AttackOnTitanDebugFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _finish(AttackOnTitanContext $ctx, bool $ok): void
    {
