...
// AttackOnTitan SDK clienttrack feature
...
class AttackOnTitanClienttrackFeature extends AttackOnTitanBaseFeature
{
    ...
    public function PostConstruct(AttackOnTitanContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AttackOnTitan-SDK';
