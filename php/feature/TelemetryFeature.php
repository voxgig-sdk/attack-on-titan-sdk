...
// AttackOnTitan SDK telemetry feature
...
class AttackOnTitanTelemetryFeature extends AttackOnTitanBaseFeature
{
    ...
    private function _close(AttackOnTitanContext $ctx, bool $ok): void
    {
