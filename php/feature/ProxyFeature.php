...
// AttackOnTitan SDK proxy feature
...
class AttackOnTitanProxyFeature extends AttackOnTitanBaseFeature
{
    ...
    public function init(AttackOnTitanContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AttackOnTitanContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
