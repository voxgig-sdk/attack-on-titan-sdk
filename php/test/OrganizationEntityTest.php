...
class OrganizationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ATTACKONTITAN_TEST_ORGANIZATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function organization_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ATTACKONTITAN_TEST_ORGANIZATION_ENTID");
