...
class TitanEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        [$titan_ref01_list_result, $err] = $titan_ref01_ent->list($titan_ref01_match, null);
        $this->assertNull($err);
        ...
        [$titan_ref01_data_dt0_loaded, $err] = $titan_ref01_ent->load($titan_ref01_match_dt0, null);
        $this->assertNull($err);
