...
// AttackOnTitan SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AttackOnTitanSDK::test)
...
{
    private const SDK_CLASS = 'AttackOnTitanSDK';
    ...
    private const SDK_BASE = 'attackontitan_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../attackontitan_sdk.php';
