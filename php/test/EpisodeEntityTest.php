...
class EpisodeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ATTACKONTITAN_TEST_EPISODE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function episode_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ATTACKONTITAN_TEST_EPISODE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ATTACKONTITAN_TEST_EPISODE_ENTID"]);
