# AttackOnTitan PHP SDK



The PHP SDK for the AttackOnTitan API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of Titan records (throws on error).
...
```
php/
├── attackontitan_sdk.php          -- Main SDK class
...
The main class (`attackontitan_sdk.php`) exports the SDK class
