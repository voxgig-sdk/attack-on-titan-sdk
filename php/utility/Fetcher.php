...
// AttackOnTitan SDK utility: fetcher

class AttackOnTitanFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AttackOnTitanSDK/1.0)';
    ...
    public static function call(AttackOnTitanContext $ctx, string $fullurl, array $fetchdef): array
    {
