...
// AttackOnTitan SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AttackOnTitanTransformResponse
{
    public static function call(AttackOnTitanContext $ctx): mixed
    {
        ...
        $transform = AttackOnTitanHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
