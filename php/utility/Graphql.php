...
// AttackOnTitan SDK utility: graphql
//
...
class AttackOnTitanGraphql
{
    ...
    // equivalent.
    public static function body(AttackOnTitanContext $ctx): mixed
    {
    ...
    public static function errors(AttackOnTitanContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
