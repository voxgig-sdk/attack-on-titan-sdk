...
type TitanEntity struct {
	name    string
	client  *core.AttackOnTitanSDK
...
func NewTitanEntity(client *core.AttackOnTitanSDK, entopts map[string]any) *TitanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TitanEntity) GetName() string { return e.name }
...
func (e *TitanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TitanEntity) Deleted() bool {
	return e.deleted
}


func (e *TitanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTitanEntity(e.client, opts)
}

func (e *TitanEntity) Data(args ...any) any {
...
func (e *TitanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Titan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TitanEntity) DataTyped(data ...Titan) Titan {
	if len(data) > 0 {
		return typedFrom[Titan](e.Data(asMap(data[0])))
	}
	return typedFrom[Titan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Titan (all fields
// optional at the wire level).
func (e *TitanEntity) MatchTyped(match ...Titan) Titan {
	if len(match) > 0 {
		return typedFrom[Titan](e.Match(asMap(match[0])))
	}
	return typedFrom[Titan](e.Match())
}
...
func (e *TitanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TitanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TitanLoadMatch and returns an Titan. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TitanEntity) LoadTyped(reqmatch TitanLoadMatch, ctrl map[string]any) (Titan, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Titan{}, err
	}
	return typedFrom[Titan](res), nil
}




func (e *TitanEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TitanListMatch and returns []Titan. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TitanEntity) ListTyped(reqmatch TitanListMatch, ctrl map[string]any) ([]Titan, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Titan](res), nil
}



func (e *TitanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TitanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TitanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TitanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
