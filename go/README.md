# AttackOnTitan Golang SDK



The Golang SDK for the AttackOnTitan API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/attack-on-titan-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/attack-on-titan-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/attack-on-titan-sdk/go=../attack-on-titan-sdk/go
```
...
```
ATTACK_ON_TITAN_TEST_LIVE=TRUE
```
...
All entities implement the `AttackOnTitanEntity` interface.
...
Create an instance: `titan := client.Titan(nil)`
