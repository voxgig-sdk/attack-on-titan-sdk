...
func TestLocationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ATTACK_ON_TITAN_TEST_LOCATION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func locationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ATTACK_ON_TITAN_TEST_LOCATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["ATTACK_ON_TITAN_TEST_LOCATION_ENTID"])
