...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "titan": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
