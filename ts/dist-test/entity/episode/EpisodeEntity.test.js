...
(0, node_test_1.describe)('EpisodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "format": "date", "name": "airDate", "req": false, "short": "Air date of the episode", "type": "`$STRING`", "index$": 0 }, { "active": true, "name": "description", "req": false, "short": "Synopsis or description of the episode", "type": "`$STRING`", "index$": 1 }, { "active": true, "name": "episodeNumber", "req": false, "short": "Episode number within the season", "type": "`$INTEGER`", "index$": 2 }, { "active": true, "name": "id", "req": false, "short": "Unique identifier for the episode", "type": "`$STRING`", "index$": 3 }, { "active": true, "name": "season", "req": false, "short": "Season number", "type": "`$INTEGER`", "index$": 4 }, { "active": true, "name": "title", "req": false, "short": "Title of the episode", "type": "`$STRING`", "index$": 5 }], "id": { "field": "id", "name": "id" }, "name": "episode", "op": { "list": { "input": "data", "name": "list", "points": [{ "active": true, "args": {}, "contract": { "id": "GET /episodes", "json": "{\"operationId\":\"getEpisodes\",\"parameters\":[],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"items\":{\"properties\":{\"airDate\":{\"description\":\"Air date of the episode\",\"format\":\"date\",\"type\":\"string\"},\"description\":{\"description\":\"Synopsis or description of the episode\",\"type\":\"string\"},\"episodeNumber\":{\"description\":\"Episode number within the season\",\"type\":\"integer\"},\"id\":{\"description\":\"Unique identifier for the episode\",\"type\":\"string\"},\"season\":{\"description\":\"Season number\",\"type\":\"integer\"},\"title\":{\"description\":\"Title of the episode\",\"type\":\"string\"}},\"type\":\"object\"},\"type\":\"array\"}}},\"description\":\"A list of episodes\"}},\"securitySource\":\"unspecified\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/episodes", "segments": [{ "lit": "episodes" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "list" }, "load": { "input": "data", "name": "load", "points": [{ "active": true, "args": { "params": [{ "active": true, "kind": "param", "name": "id", "orig": "id", "reqd": true, "type": "`$STRING`", "index$": 0 }] }, "contract": { "id": "GET /episodes/{id}", "json": "{\"operationId\":\"getEpisodeById\",\"parameters\":[{\"description\":\"The ID of the episode to retrieve\",\"in\":\"path\",\"name\":\"id\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"airDate\":{\"description\":\"Air date of the episode\",\"format\":\"date\",\"type\":\"string\"},\"description\":{\"description\":\"Synopsis or description of the episode\",\"type\":\"string\"},\"episodeNumber\":{\"description\":\"Episode number within the season\",\"type\":\"integer\"},\"id\":{\"description\":\"Unique identifier for the episode\",\"type\":\"string\"},\"season\":{\"description\":\"Season number\",\"type\":\"integer\"},\"title\":{\"description\":\"Title of the episode\",\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Episode details\"},\"404\":{\"description\":\"Episode not found\"}},\"securitySource\":\"unspecified\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/episodes/{id}", "segments": [{ "lit": "episodes" }, { "var": "id" }], "select": { "exist": ["id"] }, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "load" } }, "relations": { "ancestors": [] }, "key$": "episode", "name__orig": "episode", "Name": "Episode", "name_": "episode", "name-": "episode", "NAME": "EPISODE", "index$": 1 }, { "active": true, "entity": "episode", "key$": "BasicEpisodeFlow", "kind": "basic", "name": "BasicEpisodeFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": {}, "match": {}, "op": "list", "spec": [], "valid": [{ "apply": "ItemExists", "def": { "ref": "episode_ref01" } }], "index$": 0 }, { "active": true, "data": {}, "input": { "ref": "episode_ref01", "srcdatavar": "episode_ref01_data", "suffix": "_dt0" }, "match": { "id": "episode01" }, "op": "load", "spec": [], "valid": [{ "apply": "TextFieldMark", "def": { "mark": "Mark01-episode_ref01" } }], "index$": 1 }] }, 'Episode');
        }
...
function basicSetup(extra) {
    ...
    if (live) {
        const rawIds = process.env['ATTACK_ON_TITAN_TEST_EPISODE_ENTID'];
