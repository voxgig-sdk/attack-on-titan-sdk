...
The TypeScript SDK for the AttackOnTitan API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new AttackOnTitanSDK({ apikey: '...' })
