...
describe('exists', async () => {
  ...
  //
  // AttackOnTitanSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof AttackOnTitanSDK, true,
      'AttackOnTitanSDK.test() must return a client synchronously')
  })
