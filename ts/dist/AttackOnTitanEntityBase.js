...
exports.AttackOnTitanEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends AttackOnTitanEntityBase<Advice>`.
class AttackOnTitanEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.AttackOnTitanEntityBase = AttackOnTitanEntityBase;
//# sourceMappingURL=AttackOnTitanEntityBase.js.map