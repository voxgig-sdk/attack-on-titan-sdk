...
describe("OrganizationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ATTACK_ON_TITAN_TEST_ORGANIZATION_ENTID JSON to run live")
      return
    end
...
function organization_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ATTACK_ON_TITAN_TEST_ORGANIZATION_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["ATTACK_ON_TITAN_TEST_ORGANIZATION_ENTID"])
