...
local SDK_MODULE = "attack-on-titan_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["character"] = { ["test01"] = { id = "test01" } }, ["episode"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } }, ["organization"] = { ["test01"] = { id = "test01" } }, ["titan"] = { ["test01"] = { id = "test01" } } } }'
