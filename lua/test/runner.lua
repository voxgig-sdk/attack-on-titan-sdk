...
function runner.env_override(m)
  local live = runner.getenv("ATTACKONTITAN_TEST_LIVE")
  local override = runner.getenv("ATTACKONTITAN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ATTACKONTITAN_TEST_EXPLAIN")
