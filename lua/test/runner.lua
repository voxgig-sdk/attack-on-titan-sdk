...
function runner.env_override(m)
  local live = runner.getenv("ATTACK_ON_TITAN_TEST_LIVE")
  local override = runner.getenv("ATTACK_ON_TITAN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ATTACK_ON_TITAN_TEST_EXPLAIN")
