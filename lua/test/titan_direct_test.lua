...
describe("TitanDirect", function()
  it("should direct-list-titan", function()
    local setup = titan_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-titan", setup.live and "live" or "unit")
  ...
  it("should direct-load-titan", function()
    local setup = titan_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-titan", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function titan_direct_setup(mockres)
