...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/attack-on-titan-sdk/releases)),
...
```
lua/
├── attack-on-titan_sdk.lua    -- Main SDK module
...
The main module (`attack-on-titan_sdk`) exports the SDK constructor
