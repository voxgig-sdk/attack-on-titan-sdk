...
The Python SDK for the AttackOnTitan API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.AttackOnTitan(None).load(
    {"id": "test01"}, None
)
