# AttackOnTitan SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AttackOnTitanSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AttackOnTitanSDK(...) and AttackOnTitanSDK.test(...) become
#      AttackOnTitanSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "attackontitan_sdk"
_SDK_CLASS = "AttackOnTitanSDK"
