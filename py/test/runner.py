...
class AttackOnTitanTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AttackOnTitanTestRunner.getenv("ATTACKONTITAN_TEST_LIVE")
        override = AttackOnTitanTestRunner.getenv("ATTACKONTITAN_TEST_OVERRIDE")
        ...
        explain = AttackOnTitanTestRunner.getenv("ATTACKONTITAN_TEST_EXPLAIN")
