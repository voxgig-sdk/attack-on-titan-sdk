...
from attackontitan_sdk.utility import register

# Load features
from attackontitan_sdk.feature.base_feature import AttackOnTitanBaseFeature
from attackontitan_sdk.features import _has_feature, _make_feature
...
class AttackOnTitanSDK:
    ...
    def get_utility(self):
        return AttackOnTitanUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AttackOnTitanSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from attackontitan_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from attackontitan_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from attackontitan_sdk.entity.location_entity import LocationEntity
    ...
    def Organization(self, data=None) -> "OrganizationEntity":
        ...
        from attackontitan_sdk.entity.organization_entity import OrganizationEntity
    ...
    def Titan(self, data=None) -> "TitanEntity":
        ...
        from attackontitan_sdk.entity.titan_entity import TitanEntity
