...
A RESTful API that provides access to a wide range of data related to the popular anime and manga series 'Attack on Titan'.

Learn more about Attack on Titan API at [attackontitanapi.com](https://attackontitanapi.com).
...
This SDK exposes the API as a small set of **semantic entities** — Character, Episode, Location, Organization and Titan — that you
...
| **Titan** | The Titan entity (list, load). | `/titans` |
