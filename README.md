...
This is an unofficial SDK for the Attack on Titan public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/attack-on-titan` | `npm install @voxgig-sdk/attack-on-titan` |
| Python | `voxgig-sdk-attack-on-titan` | `pip install voxgig-sdk-attack-on-titan` |
| PHP | `voxgig-sdk/attack-on-titan` | `composer require voxgig-sdk/attack-on-titan` |
| Golang | `github.com/voxgig-sdk/attack-on-titan-sdk/go` | `go get github.com/voxgig-sdk/attack-on-titan-sdk/go` |
| Ruby | `voxgig-sdk-attack-on-titan` | `gem install voxgig-sdk-attack-on-titan` |
| Lua | `voxgig-sdk-attack-on-titan` | `luarocks install voxgig-sdk-attack-on-titan` |
...
- Upstream API: [https://www.attackontitanapi.com/](https://www.attackontitanapi.com/)
